...
def main():
    ...
    parser.add_argument("--save_path", type=str, default="SynapSCIM_gnn_checkpoints/gnn_ppo_model_final.pt")
    ...
    for iteration in range(start_iteration, args.total_iterations + 1):
        ...
        if iteration in [10000, 15000, 20000] or (iteration % 1000 == 0):
            ...
            checkpoint_name = f"gnn_ppo_model_{iteration}.pt"
